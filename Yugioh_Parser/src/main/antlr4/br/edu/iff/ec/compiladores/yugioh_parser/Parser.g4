...
TYPE: 'AQUA'| 'MAGO'| 'DEMÔNIO'| 'DINOSSAURO'|'NORMAL'|'EFEITO'|'DRAGÃO'|
      ...
      'MAGO/REGULADOR'|'DEMÔNIO/REGULADOR' | 'DINOSSAURO/REGULADOR' | 'NORMAL/REGULADOR' | 'EFEITO/REGULADOR' | 'DRAGÃO/REGULADOR' |
      'FADA/REGULADOR' | 'BESTA/REGULADOR' | 'BESTA-GUERREIRA/REGULADOR' | 'BESTA-ALADA/REGULADOR' | 'BESTA-DIVINA/REGULADOR' |
      ...
      'ZUMBI/REGULADOR' | 'DEUS-CRIADOR/REGULADOR' | 'CIBERSO/REGULADOR' | 'FUSÃO/REGULADOR' | 'XYZ/REGULADOR' | 'SINCRO/REGULADOR'
      ;
